...
export default {
  ...
  methods: {
    async saveChanges() {
      if (this.tempBackgroundImage) this.event.checkin_background_image = this.tempBackgroundImage;
      if (this.tempSuccessAudio) this.event.checkin_success_audio = this.tempSuccessAudio;
      if (this.tempFailedAudio) this.event.checkin_failed_audio = this.tempFailedAudio;
